...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        lat0, lon0 = read_home(filename)
        # TODO: set home position to (lon0, lat0, 0)
        self.set_home_position(lon0, lat0, 0)
        # TODO: retrieve current global position
        #local_global_position = [self._longitude, self._latitude, self._altitude]
        ...
        grid_start = (int(np.ceil(local_north - north_offset)),
...
if __name__ == "__main__":
    ...
    parser.add_argument('--goal_lat', type=str, default='37.795850', help="Goal latitude")
    parser.add_argument('--goal_lon', type=str, default='-122.393132', help="Goal longitude")
